...
class WindowTwo(tk.Toplevel):
    ...
    def __init__(self, parent: tk.Tk):
        ...
        # Things outside of this class do not need access to these variables
        self._data_entry: ttk.Entry = tk.Entry(self, width=50, bg='blue', fg='yellow')
